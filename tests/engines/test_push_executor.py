...
def test_push_executor_with_selector():
    ...
    push = Push(instance=push_instance, selector="data.a", unwrap=False, deps=[])
    dut = PushExecutor()
...
def test_push_executor_with_deps():
    ...
    dep_push = Push(instance=dep_instance, selector=None, deps=[], unwrap=False)
    push = Push(instance=push_instance, selector=None, unwrap=False, deps=[dep_push])
...
def test_push_executor_unwrap():
    ...
    dep_instance = Nop(name='pytest2')
    dep_push = Push(instance=dep_instance, selector=None, deps=[], unwrap=False)
    push = Push(instance=push_instance, selector=None, unwrap=True, deps=[dep_push])
...
def test_push_executor_unwrap_selector():
    ...
    dep_instance = Nop(name='pytest2')
    dep_push = Push(instance=dep_instance, selector=None, deps=[], unwrap=False)
    push = Push(instance=push_instance, selector="str(data)[0]", unwrap=True, deps=[dep_push])
